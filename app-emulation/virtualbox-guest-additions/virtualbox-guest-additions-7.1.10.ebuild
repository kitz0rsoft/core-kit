...
SRC_URI="https://download.virtualbox.org/virtualbox/7.1.10/VirtualBox-7.1.10.tar.bz2 -> VirtualBox-7.1.10.tar.bz2"
...
src_install() {
	...
	if use dbus; then
		...
		newinitd <(sed 's/ dbus\>//' "${FILESDIR}"/${PN}-8.initd) ${PN}
	fi
